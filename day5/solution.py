...
Your puzzle answer was 12428642.


Refactor opcode machine in day 2.
Add 2 new opcodes for 3 and 4.
For opcode 3, gather user input. In this problem, we always input 1.
For opcode 4, just print out parameter.

Enable parameter modes for all opcodes. 
"""
fo = open('input.txt')
